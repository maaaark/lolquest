<table class="table table-striped timeline-table">
	@foreach($timelines as $post)
		<tr>
			...
			<td  style="width: 30px !important;"><a href="/summoner/{{ $post->friend->region }}/{{ $post->friend->summoner_name }}"><img src="http://ddragon.leagueoflegends.com/cdn/5.8.1/img/profileicon/{{ $user->summoner->profileIconId }}.png" class="img-circle" width="30" /></a></td>
