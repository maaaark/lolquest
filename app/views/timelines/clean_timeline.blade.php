<table class="table table-striped timeline-table">
	@foreach($timelines as $post)
		<tr>
			<td style="width: 30px !important;"><a href="/summoner/{{ $post->user->region }}/{{ $post->user->summoner_name }}"><img src="http://ddragon.leagueoflegends.com/cdn/5.8.1/img/profileicon/{{ $post->user->summoner->profileIconId }}.png" class="img-circle" width="30" /></a></td>
			@if($post->event_type == "quest_create")
			<td><a href="/champions/{{ $post->quest->champion->key }}"><img class="img-circle quest_avatar" alt="{{ $post->quest->champion->name }}" src="http://ddragon.leagueoflegends.com/cdn/5.8.1/img/champion/{{ $post->quest->champion->key }}.png" width="30" title="{{ $post->quest->champion->name }}" /></a></td>
			
			<td>{{ $post->quest->questtype->name }}</td>
			@elseif($post->event_type == "quest_end")
			<td  style="width: 30px !important;"><a href="/champions/{{ $post->quest->champion->key }}"><img class="img-circle quest_avatar" alt="{{ $post->quest->champion->name }}" src="http://ddragon.leagueoflegends.com/cdn/5.8.1/img/champion/{{ $post->quest->champion->key }}.png" width="30" title="{{ $post->quest->champion->name }}" /></a></td>
			...
			<td  style="width: 30px !important;"><a href="/summoner/{{ $post->friend->region }}/{{ $post->friend->summoner_name }}"><img src="http://ddragon.leagueoflegends.com/cdn/5.8.1/img/profileicon/{{ $post->friend->profileIconId }}.png" class="img-circle" width="30" /></a></td>
