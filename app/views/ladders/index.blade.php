...
@section('content')
	...
	@foreach($ladder as $row)
		<tr>
			...
			<td width="20"><a href="/summoner/{{ $row->user->region }}/{{ $row->user->summoner_name }}"><img src="http://ddragon.leagueoflegends.com/cdn/5.8.1/img/profileicon/{{ $row->user->summoner->profileIconId }}.png" class="img-circle" width="20" /></a></td>
