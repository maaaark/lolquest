...
@section('content')
	...
	@foreach($users as $row)
		<tr>
			...
			<td width="20"><a href="/summoner/{{ $row->region }}/{{ $row->summoner_name }}"><img src="/img/profileicons/profileIcon{{ $row->summoner->profileIconId }}.jpg" class="img-circle" width="20" /></a></td>
